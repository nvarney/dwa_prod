...
# Ideally, this should match the domain name
	define('APP_EMAIL', 'webmaster@nathanielvarney.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'webmaster@nathanielvarney.com'); 
...
# For extra security, you might want to set different salts than what the core uses
	//define('PASSWORD_SALT', 'Magneto');
	//define('TOKEN_SALT', 'ProfessorX');